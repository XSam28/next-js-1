...
export default async function Blogs({promise}) {
  ...
  return (
    ...
    <Image className="object-cover scale-125 hover:scale-105 transition-all opacity-0" src={imgData.url} alt="Sorry Can't render image" width={600} height={500} onLoadingComplete={(image) => image.classList.remove("opacity-0")}/>
    </div>
    </Link>
